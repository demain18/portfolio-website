    ...
    <div id="app">
      <div id="gnb">
        ...
        <div class="lang" @click="langSelectClick">
          <img
            :src="require(`~/assets/img/flag-${lang.flagName[lang.set]}.png`)"
          />
      ...
      <div id="container">
        <div class="profile">
          ...
          <div class="links">
            <p>
              ...
              <a href="https://github.com/demain18" target="_blank"
                >github.com/demain18</a
              >
            </p>
            <p>
              <img src="~assets/img/icon/icon-insta-dark.png" />
              <a href="https://www.instagram.com/baeksan01/" target="_blank"
                >instagram.com/baeksan</a
              >
            </p>
            <p>
              <img src="~assets/img/icon/icon-book.png" />
              <a href="https://demain18-blog.tistory.com/" target="_blank"
                >baeksan.tistory.blog</a
              >
            </p>
            <br />
            <p>
            ...
            <div
              class="map-grid"
              @mouseover="eventHoverIn"
              @mouseleave="eventHoverOut"
            >
        ...
        <div class="section">
          ...
          <div v-if="lang.set == 0">
            <p class="content">
              ...
              가지고 있는 아이디어를 웹 어플리케이션으로 만들어내는 일을 즐기며
              그 과정에서 얻는 성취감을 좋아합니다.<br />
              작은 규모에서 시작해서 사용자가 늘어나며 생태계가 생기고 서비스가
              성장하는 모습을 보는것이 제가 개발을 하는 이유입니다.
            </p>
            <p class="content">
              본업은 개발이지만 이외에도 작곡나 글쓰기와 같은 취미가 있으며<br />
              다른 분야에서도 작품을 만들어 사람들에게 저만의 감성을 전하고자
              합니다.<br />
              모든 활동은 블로그나 인스타그램에서 진행되고 있으니 많은 관심
              가져주세요!
            </p>
          </div>
          <div v-if="lang.set == 1">
            <p class="content">
              ...
              I am really enthusiastic about transformimng my ideas into web
              application, and also fully enjoy accomplishment acquired in the
              course of it. <br />
              Starting from a small scale, seeing a growth of users, eco-systems
              are created and services evolve really motivates me.
            </p>
            <p class="content">
              Other than my main job as IT engineer, I have hobbies such as
              composing and writing, because<br />
              I also hope to emotionally attract people with my own unique sense
              through works at other fields.<br />
              All the activities are on my blogs and Instagram, so your
              attention would be so thanked.
            </p>
          </div>
          <div v-if="lang.set == 2">
            <p class="content">
        ...
        <div class="section">
          ...
          <div class="list">
            <div class="item">
              <img src="~assets/img/stack/stack-react.png" />
            </div>
            <div class="item">
              <img src="~assets/img/stack/stack-typescript.png" />
            </div>
            <div class="item">
              <img src="~assets/img/stack/stack-codeigniter.png" />
            </div>
            <div class="item">
              <img src="~assets/img/stack/stack-docker.png" />
            </div>
            <div class="item">
              <img src="~assets/img/stack/stack-aws.png" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="project">
        ...
        <div class="flex">
          <div
            v-for="(item, index) in projectList.items"
            :key="index"
            @mouseover="projectContentToggle('in', index)"
            @mouseleave="projectContentToggle('out', index)"
            @click="dialogToggle(index)"
            class="item-grid"
          >
            <img
              :src="require(`~/assets/img/upload/${item.folderName}/1.png`)"
              alt=""
            />
      ...
      <v-dialog
        v-model="dialog.on"
        @click:outside="dialogClose(dialog.index)"
        width="1200"
      >
        <v-card>
          <v-card-text>
            <div class="content">
              ...
              <a
                v-if="projectList.items[dialog.index].content.link != null"
                :href="projectList.items[dialog.index].content.link"
                target="_blank"
                ><v-icon>mdi-earth</v-icon></a
              >
              <a
                v-if="projectList.items[dialog.index].content.github != null"
                :href="projectList.items[dialog.index].content.github"
                target="_blank"
                ><v-icon>mdi-github</v-icon></a
              >
              <div class="chip-wrap">
                <v-chip
                  v-for="(item, index) in projectList.items[dialog.index]
                    .content.stack"
                  :key="index"
                  >{{ item }}</v-chip
                >
          ...
          <v-card-text>
            <img
              ...
              :key="index"
              :src="
                require(`~/assets/img/upload/${
                  projectList.items[dialog.index].folderName
                }/${item}.png`)
              "
            />
          </v-card-text>
  ...
  data: () => ({
    ...
    projectList: {
      items: [
        {
          contentToggle: false,
          folderName: "linkedin-clone",
          imgCount: 5,
          content: {
            title: "링크드인 클론",
            category: "개인 프로젝트",
            link: "https://linkedin-clone-5d4a9.web.app/",
            github: "https://github.com/demain18/linkedin-clone",
            stack: [
              "Typescript",
              "React",
              "Next.js",
        ...
        },
        {
          ...
          content: {
            ...
            stack: ["React", "Codeigniter", "Mysql", "AWS"]
          }
        },
        {
          contentToggle: false,
